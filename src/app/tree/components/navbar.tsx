...
const Navbar: React.FC<NavbarProps> = ({ treeId, refreshTree }) => {
  ...
  const [familyName, setFamilyName] = useState('wotchoko Family Tree');
  const [username, setUsername] = useState('yohan wotchoko');
    ...
    <div className="bg-white border-b border-gray-200">
      <div className="flex items-center justify-between px-4 py-2">
        ...
        <div className="flex items-center">
          <h1 className="text-lg font-medium text-gray-700">{familyName}</h1>
